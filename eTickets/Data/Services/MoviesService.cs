...
namespace eTickets.Data.Services
{
    public class MoviesService : EntityBaseRepository<Movie>, IMoviesService
    {
        ...
        public async Task AddNewMoviewAsync(NewMovieVM data)
        {
        ...
        public async Task UpdateMoviewAsync(NewMovieVM data)
        {
            var dbMovie = await _context.Movies.Include(m => m.Actor_Movies)
